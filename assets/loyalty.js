...
const YOTPO_LOADER_SRC = 'https://cdn-yotpo.com/ayCQoNgVgsMXREbYl_jUOQ/widget.js';
...
document.addEventListener('click', (e) => {
  const el = e.target.closest('.yotpo-sticky-rewards, .yotpo-widget-sticky-rewards');
  if (!el) return;
  const email = localStorage.getItem('ja_email');
  if (!email) {
    e.preventDefault();
